...
CREATE OR REPLACE FUNCTION trg_set_file_ext()  -- strips query string, takes text after final dot
...
CREATE TABLE faces (
    ...
    bbox        JSONB    NOT NULL,       -- {"x":10,"y":20,"w":30,"h":40}
...
INSERT INTO faces (image_id, image_uuid, cluster_id, bbox, embedding) VALUES
(
