...
def main() -> None:
                    ...
                    if new == orig:
                        ...
                        try:
                            update_event(
                                ...
                                start_date_time=datetime.fromisoformat(new["start"]),
    ...
    with tab_create:
        ...
        with st.form("create_event_form"):
            ...
            name = (st.text_input("Event Name", placeholder="Optional") or "").strip()
            desc = (st.text_area("Description", placeholder="Optional") or "").strip()
